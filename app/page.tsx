...
const FEATURES = [
  {
    icon: "🗂️",
    title: "すべてを一画面に",
    desc: "Chatwork、Slack、Discord、Teams…バラバラに開いていたアプリをサイドバーひとつで切り替え。",
  },
  {
    icon: "🔔",
    title: "通知バッジ対応",
...
export default function Home() {
  return (
    <div className="min-h-screen flex flex-col" style={{ background: "#0d1526", color: "#e8e8f8" }}>
      {/* Header */}
      <header
        className="sticky top-0 z-50 backdrop-blur-md"
        style={{ borderBottom: "1px solid rgba(255,255,255,0.08)", background: "rgba(13,21,38,0.9)" }}
      >
        <div className="max-w-6xl mx-auto px-6 py-4 flex items-center justify-between">
          <div className="flex items-center gap-1">
            <span className="text-2xl font-bold" style={{ color: "#4ade80" }}>Hub</span>
      ...
      <section className="flex flex-col items-center justify-center text-center px-6 py-28">
        ...
        <h1 className="text-4xl md:text-6xl font-bold leading-tight mb-6">
          すべてのチャットを<br />
          <span style={{ color: "#4ade80" }}>一つに。</span>
        </h1>
        <p className="text-lg md:text-xl max-w-2xl mb-10 leading-relaxed" style={{ color: "#7878a8" }}>
          Chatwork・Slack・Discord・Teams・LINE WORKS…<br />
          バラバラなアプリを <strong style={{ color: "#e8e8f8" }}>HubChat</strong> でまとめて管理。<br />
          月額 <strong style={{ color: "#4ade80" }}>380円</strong> で全サービスが使い放題。
        </p>
        <div className="flex flex-col sm:flex-row gap-4">
          <a
            href="#download"
            className="px-8 py-4 rounded-xl text-base font-bold transition-opacity hover:opacity-85"
            style={{ background: "#4ade80", color: "#0d1526" }}
          >
            無料トライアルを始める →
          </a>
      ...
      {/* Features */}
      <section id="features" className="py-24 px-6" style={{ background: "#1a2744" }}>
          ...
          <div className="grid md:grid-cols-2 gap-6">
            {FEATURES.map((f) => (
              <div
                ...
                style={{ background: "#162033", border: "1px solid rgba(255,255,255,0.06)" }}
              >
      ...
      <section id="pricing" className="py-24 px-6">
        <div className="max-w-md mx-auto text-center">
          ...
          <div
            ...
            style={{ background: "#162033", border: "2px solid rgba(74,222,128,0.4)" }}
          >
            <div className="text-sm font-semibold mb-2" style={{ color: "#4ade80" }}>スタンダードプラン</div>
            ...
            <a
              href="#download"
              className="block w-full py-3 rounded-xl font-bold text-center transition-opacity hover:opacity-85"
              style={{ background: "#4ade80", color: "#0d1526" }}
            >
              14日間無料で試す
            </a>
      ...
      {/* Download */}
      <section id="download" className="py-24 px-6 text-center" style={{ background: "#1a2744" }}>
